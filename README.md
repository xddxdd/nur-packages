...
|  | `axonhub` | [axonhub](https://github.com/looplj/axonhub) | 0.9.43 | Open-source AI gateway with built-in failover, load balancing, cost control and end-to-end tracing |
...
| `x86_64-linux` | `browseros` | [browseros](https://www.browseros.com) | agent-server/v0.0.145 | Open source agentic browser |
...
|  | `cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.142 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `cryptodev-unstable` | [cryptodev-linux](http://cryptodev-linux.org/) | cryptodev-linux-1.14-unstable-2025-11-03 | Device that allows access to Linux kernel cryptographic drivers |
...
|  | `emperors-scepter` | [emperors-scepter](https://honkai-star-rail.fandom.com/wiki/As_I%27ve_Written/%CE%B4-me13.exe) | 0.1.0-6.18.45 | Idle kthreads for the twelve Scepter δ-me13 signals |
...
|  | `extenddb` | [extenddb](https://github.com/ExtendDB/extenddb) | 0.1.8 | DynamoDB-compatible API adapter backed by PostgreSQL |
...
|  | `funasr` | [funasr](https://www.funasr.com/) | 1.4.3-unstable-2026-08-24 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
|  | `geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2026.08.25 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `hack3ric-flow` | [hack3ric-flow](https://github.com/hack3ric/flow) | 0.2.0-unstable-2026-04-05 | BGP flowspec executor |
...
|  | `liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2026-08-19 | C library for prototyping and experimenting with quantum-resistant cryptography |
|  | `lightpanda` | [lightpanda](https://lightpanda.io) | 0.3.7 | Headless browser designed for AI and automation |
...
|  | `loralib` | [loralib](https://arxiv.org/abs/2106.09685) | RoBERTa-large-unstable-2024-12-17 | Implementation of "LoRA: Low-Rank Adaptation of Large Language Models" |
...
|  | `mtkclient` | [mtkclient](https://github.com/bkerler/mtkclient) | 2.1.4.1-unstable-2026-08-02 | MTK reverse engineering and flash tool |
...
|  | `ncmm` | [ncmm](https://github.com/3899/ncmm) | 1.1.15 | Command-line assistant for NetEase Cloud Music musicians |
...
|  | `nullfs` | [nullfs](https://github.com/xrgtn/nullfs) | 0-unstable-2016-01-27 | FUSE nullfs drivers |
...
|  | `openssl-oqs-provider` | [openssl-oqs-provider](https://openquantumsafe.org) | 0.11.0-unstable-2026-08-21 | OpenSSL 3 provider containing post-quantum algorithms |
...
|  | `peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | 9.5.0 | Automatically bans unwanted, leeching, and anomalous BT clients, with support for custom rules for qBittorrent and Transmission |
...
|  | `rime-aurora-pinyin` | [rime-aurora-pinyin](https://github.com/hosxy/rime-aurora-pinyin) | 0-unstable-2022-08-27 | 【极光拼音】输入方案 |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | nightly-unstable-2026-08-22 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `route-chain` | [route-chain](https://github.com/xddxdd/route-chain) | 1.1.0-unstable-2026-01-09 | Small app to generate a long path in traceroute |
|  | `rtpengine` | [rtpengine](https://github.com/sipwise/rtpengine) | mr26.2.1.1-unstable-2026-08-17 | Sipwise media proxy for Kamailio |
...
|  | `runpodctl` | [runpodctl](https://www.runpod.io) | 2.11.0 | RunPod CLI for pod management |
...
| `x86_64-linux` | `sgx-software-enable` | [sgx-software-enable](https://github.com/intel/sgx-software-enable) | 1.0-unstable-2023-01-07 | Application to enable Intel SGX on Linux systems |
...
|  | `sx1302-hal` | [sx1302-hal](https://github.com/NebraLtd/sx1302_hal) | DEV_USB_LBT_EARLY_ACCESS-unstable-2023-02-06 | SX1302/SX1303 Hardware Abstraction Layer and tools |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 1.7.252-unstable-2026-08-22 | Unifies the management of LLM APIs across multiple backend services |
...
|  | `vlmcsd` | [vlmcsd](https://github.com/Wind4/vlmcsd) | svn1113-unstable-2023-07-28 | KMS Emulator in C |
...
|  | `xt_rtpengine` | [xt_rtpengine](https://github.com/sipwise/rtpengine) | mr26.2.1.1-unstable-2026-08-17 | Sipwise media proxy for Kamailio (kernel module) |
...
|  | `kernel-modules.cryptodev-unstable` | [cryptodev-linux](http://cryptodev-linux.org/) | cryptodev-linux-1.14-unstable-2025-11-03 | Device that allows access to Linux kernel cryptographic drivers |
...
|  | `kernel-modules.emperors-scepter` | [emperors-scepter](https://honkai-star-rail.fandom.com/wiki/As_I%27ve_Written/%CE%B4-me13.exe) | 0.1.0-6.18.45 | Idle kthreads for the twelve Scepter δ-me13 signals |
...
|  | `kernel-modules.xt_rtpengine` | [xt_rtpengine](https://github.com/sipwise/rtpengine) | mr26.2.1.1-unstable-2026-08-17 | Sipwise media proxy for Kamailio (kernel module) |
</details>
...
|  | `lantianCustomized.ffmpeg` | [ffmpeg](https://www.ffmpeg.org/) | 9.0 | FFmpeg with Lan Tian modifications |
...
|  | `lantianCustomized.firefox-unwrapped` | [firefox-unwrapped](https://github.com/feder-cr/firefox_antidetect_patch) | 153.1.0esr | Firefox with anti fingerprinting modifications |
...
|  | `lantianCustomized.nbfc-linux` | [nbfc-linux-lantian](https://github.com/xddxdd/nbfc-linux) | 0.1.6-unstable-2022-06-14 | NoteBook FanControl ported to Linux (with Lan Tian's modifications) |
...
| `x86_64-linux` | `nvidia-grid.gridKmod.11_8` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 450.191.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.12_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 460.106.00-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.13_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.63.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.13_12` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.256.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.13_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.129.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.13_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.141.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.13_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.161.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.13_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.161.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.13_7` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.182.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.13_9` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.223.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.14_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.47.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.14_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.73.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.14_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.85.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.14_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.108.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.14_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.108.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.15_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.60.13-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.15_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.85.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.15_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.105.17-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.15_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.125.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.54.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.104.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_10` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.247.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_11` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.261.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_12` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.274.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_13` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.288.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_14` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.309.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.129.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.154.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.161.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.161.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.183.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_7` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.183.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_8` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.216.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.16_9` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.230.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.17_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.54.14-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.17_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.54.15-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.17_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.90.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.17_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.90.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.17_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.127.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.17_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.144.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.17_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.163.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.18_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.124.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.18_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.133.20-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.18_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.148.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.18_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.158.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.18_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.172.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.18_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.195.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.18_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.211.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.19_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.65.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.19_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.82.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.19_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.95.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.19_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.105.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.19_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.126.09-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.19_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.159.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.19_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.178.04-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.20_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.58.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.20_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.71.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.20_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.91.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.gridKmod.9_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 430.63-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
...
| `x86_64-linux` | `nvidia-grid.guestKmod.11_8` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 450.191.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.12_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 460.106.00-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.13_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.63.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.13_12` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.256.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.13_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.129.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.13_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.141.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.13_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.161.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.13_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.161.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.13_7` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.182.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.13_9` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.223.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.14_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.47.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.14_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.73.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.14_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.85.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.14_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.108.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.14_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.108.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.15_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.60.13-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.15_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.85.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.15_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.105.17-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.15_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.125.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.54.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.104.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_10` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.247.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_11` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.261.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_12` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.274.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_13` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.288.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_14` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.309.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.129.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.154.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.161.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.161.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.183.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_7` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.183.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_8` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.216.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.16_9` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.230.02-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.17_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.54.14-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.17_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.54.15-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.17_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.90.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.17_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.90.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.17_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.127.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.17_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.144.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.17_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.163.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.18_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.124.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.18_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.133.20-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.18_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.148.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.18_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.158.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.18_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.172.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.18_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.195.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.18_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.211.01-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.19_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.65.06-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.19_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.82.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.19_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.95.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.19_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.105.08-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.19_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.126.09-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.19_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.159.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.19_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.178.04-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.20_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.58.03-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.20_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.71.05-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.20_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.91.07-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.guestKmod.9_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 430.63-6.18.45 | NVIDIA vGPU guest driver (GRID driver, experimental package) - Kernel modules |
...
| `x86_64-linux` | `nvidia-grid.hostKmod.11_8` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 450.191-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.12_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 460.107-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.13_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.63-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.13_12` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.256.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.13_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.129.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.13_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.141.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.13_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.161.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.13_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.161.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.13_7` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.182.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.13_9` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.223.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.14_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.47.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.14_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.73.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.14_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.85.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.14_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.108.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.14_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.108.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.15_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.60.12-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.15_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.85.07-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.15_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.105.14-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.15_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.125.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.54.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.104.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_10` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.247.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_11` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.261.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_12` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.274.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_13` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.288.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_14` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.309.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.129.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.154.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.161.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.161.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.183.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_7` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.183.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_8` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.216.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.16_9` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.230.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.17_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.54.10-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.17_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.54.16-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.17_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.90.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.17_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.90.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.17_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.127.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.17_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.144.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.17_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.163.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.18_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.124.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.18_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.133.10-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.18_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.148.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.18_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.158.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.18_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.172.07-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.18_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.195.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.18_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.211.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.19_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.65.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.19_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.82.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.19_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.95.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.19_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.105.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.19_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.126.08-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.19_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.159.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.19_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.178.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.20_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.58.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.20_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.71.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.20_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.91.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.hostKmod.9_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 430.67-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
...
| `x86_64-linux` | `nvidia-grid.vgpuKmod.11_8` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 450.191-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.12_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 460.107-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.13_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.63-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.13_12` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.256.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.13_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.129.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.13_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.141.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.13_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.161.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.13_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.161.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.13_7` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.182.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.13_9` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 470.223.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.14_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.47.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.14_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.73.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.14_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.85.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.14_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.108.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.14_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 510.108.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.15_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.60.12-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.15_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.85.07-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.15_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.105.14-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.15_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 525.125.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.54.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.104.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_10` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.247.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_11` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.261.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_12` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.274.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_13` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.288.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_14` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.309.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.129.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.154.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.161.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.161.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.183.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_7` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.183.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_8` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.216.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.16_9` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 535.230.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.17_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.54.10-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.17_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.54.16-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.17_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.90.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.17_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.90.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.17_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.127.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.17_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.144.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.17_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 550.163.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.18_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.124.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.18_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.133.10-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.18_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.148.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.18_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.158.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.18_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.172.07-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.18_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.195.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.18_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 570.211.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.19_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.65.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.19_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.82.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.19_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.95.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.19_3` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.105.06-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.19_4` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.126.08-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.19_5` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.159.01-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.19_6` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 580.178.05-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.20_0` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.58.02-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.20_1` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.71.03-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.20_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 595.91.04-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
| `x86_64-linux` | `nvidia-grid.vgpuKmod.9_2` | [nvidia-kernel-modules](https://www.nvidia.com/object/unix.html) | 430.67-6.18.45 | NVIDIA vGPU host driver (vGPU-KVM driver, experimental package) - Kernel modules |
</details>
...
| `x86_64-linux` | `openjdk-adoptium.jdk-bin-8` | [openjdk-adoptium-jdk-bin](https://adoptium.net/) | 8u504-b01_adopt | OpenJDK binaries built by Eclipse Adoptium |
...
| `x86_64-linux` | `openjdk-adoptium.jdk-bin-8u504_b01` | [openjdk-adoptium-jdk-bin](https://adoptium.net/) | 8u504-b01_adopt | OpenJDK binaries built by Eclipse Adoptium |
...
| `x86_64-linux` | `openjdk-adoptium.jre-bin-8` | [openjdk-adoptium-jre-bin](https://adoptium.net/) | 8u504-b01_adopt | OpenJDK binaries built by Eclipse Adoptium |
...
| `x86_64-linux` | `openjdk-adoptium.jre-bin-8u504_b01` | [openjdk-adoptium-jre-bin](https://adoptium.net/) | 8u504-b01_adopt | OpenJDK binaries built by Eclipse Adoptium |
</details>
...
|  | `python3Packages.funasr` | [funasr](https://www.funasr.com/) | 1.4.3-unstable-2026-08-24 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `python3Packages.loralib` | [loralib](https://arxiv.org/abs/2106.09685) | RoBERTa-large-unstable-2024-12-17 | Implementation of "LoRA: Low-Rank Adaptation of Large Language Models" |
...
|  | `python3Packages.mtkclient` | [mtkclient](https://github.com/bkerler/mtkclient) | 2.1.4.1-unstable-2026-08-02 | MTK reverse engineering and flash tool |
...
|  | `uncategorized.axonhub` | [axonhub](https://github.com/looplj/axonhub) | 0.9.43 | Open-source AI gateway with built-in failover, load balancing, cost control and end-to-end tracing |
...
| `x86_64-linux` | `uncategorized.browseros` | [browseros](https://www.browseros.com) | agent-server/v0.0.145 | Open source agentic browser |
...
|  | `uncategorized.cliproxyapi` | [cliproxyapi](https://github.com/router-for-me/CLIProxyAPI) | 7.2.142 | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service |
...
|  | `uncategorized.extenddb` | [extenddb](https://github.com/ExtendDB/extenddb) | 0.1.8 | DynamoDB-compatible API adapter backed by PostgreSQL |
...
|  | `uncategorized.geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2026.08.25 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `uncategorized.hack3ric-flow` | [hack3ric-flow](https://github.com/hack3ric/flow) | 0.2.0-unstable-2026-04-05 | BGP flowspec executor |
...
|  | `uncategorized.liboqs-unstable` | [liboqs](https://openquantumsafe.org) | 0-unstable-2026-08-19 | C library for prototyping and experimenting with quantum-resistant cryptography |
|  | `uncategorized.lightpanda` | [lightpanda](https://lightpanda.io) | 0.3.7 | Headless browser designed for AI and automation |
...
|  | `uncategorized.ncmm` | [ncmm](https://github.com/3899/ncmm) | 1.1.15 | Command-line assistant for NetEase Cloud Music musicians |
...
|  | `uncategorized.openssl-oqs-provider` | [openssl-oqs-provider](https://openquantumsafe.org) | 0.11.0-unstable-2026-08-21 | OpenSSL 3 provider containing post-quantum algorithms |
...
|  | `uncategorized.peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | 9.5.0 | Automatically bans unwanted, leeching, and anomalous BT clients, with support for custom rules for qBittorrent and Transmission |
...
|  | `uncategorized.rime-aurora-pinyin` | [rime-aurora-pinyin](https://github.com/hosxy/rime-aurora-pinyin) | 0-unstable-2022-08-27 | 【极光拼音】输入方案 |
...
|  | `uncategorized.rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | nightly-unstable-2026-08-22 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uncategorized.route-chain` | [route-chain](https://github.com/xddxdd/route-chain) | 1.1.0-unstable-2026-01-09 | Small app to generate a long path in traceroute |
|  | `uncategorized.rtpengine` | [rtpengine](https://github.com/sipwise/rtpengine) | mr26.2.1.1-unstable-2026-08-17 | Sipwise media proxy for Kamailio |
|  | `uncategorized.runpodctl` | [runpodctl](https://www.runpod.io) | 2.11.0 | RunPod CLI for pod management |
...
| `x86_64-linux` | `uncategorized.sgx-software-enable` | [sgx-software-enable](https://github.com/intel/sgx-software-enable) | 1.0-unstable-2023-01-07 | Application to enable Intel SGX on Linux systems |
...
|  | `uncategorized.sx1302-hal` | [sx1302-hal](https://github.com/NebraLtd/sx1302_hal) | DEV_USB_LBT_EARLY_ACCESS-unstable-2023-02-06 | SX1302/SX1303 Hardware Abstraction Layer and tools |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 1.7.252-unstable-2026-08-22 | Unifies the management of LLM APIs across multiple backend services |
...
|  | `uncategorized.vlmcsd` | [vlmcsd](https://github.com/Wind4/vlmcsd) | svn1113-unstable-2023-07-28 | KMS Emulator in C |
