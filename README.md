...
<details>
<summary>Package set: (Uncategorized) (127 packages)</summary>
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | unstable-2024-08-13 | Rime 配置：雾凇拼音 | 长期维护的简体词库  |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggerganov/llama.cpp/) | 3585 | Port of Facebook's LLaMA model in C/C++ |
...
|  | `lantianCustomized.nginx` | [nginx-lantian](https://openresty.org) | unstable-2024-08-15 | OpenResty with Lan Tian modifications |
