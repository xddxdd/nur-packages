...
|  | `geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2025.11.07 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `vector-quantize-pytorch` | [vector-quantize-pytorch](https://github.com/lucidrains/vector-quantize-pytorch) | 1.25.0 | Vector (and Scalar) Quantization, in Pytorch |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 6970 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `python3Packages.vector-quantize-pytorch` | [vector-quantize-pytorch](https://github.com/lucidrains/vector-quantize-pytorch) | 1.25.0 | Vector (and Scalar) Quantization, in Pytorch |
...
|  | `uncategorized.geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2025.11.07 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
