...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2024-12-09 | Unifies the management of LLM APIs. Call multiple backend services through a unified API interface |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggerganov/llama.cpp/) | 4293 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
| State | Path | Name | Version | Description |
| ----- | ---- | ---- | ------- | ----------- |
|  | `lantianLinuxXanmod.generic` | [linux-xanmod-generic](https://www.kernel.org/) | 6.12.3-xanmod1 | Linux Xanmod Kernel with Lan Tian Modifications |
|  | `lantianLinuxXanmod.generic-configfile` | linux-config | 6.12.3-xanmod1 |  |
|  | `lantianLinuxXanmod.generic-lto` | [linux-xanmod-generic-lto](https://www.kernel.org/) | 6.12.3-xanmod1 | Linux Xanmod Kernel with Lan Tian Modifications and Clang+ThinLTO |
|  | `lantianLinuxXanmod.generic-lto-configfile` | linux-config | 6.12.3-xanmod1 |  |
|  | `lantianLinuxXanmod.latest-generic` | [linux-xanmod-latest-generic](https://www.kernel.org/) | 6.12.3-xanmod1 | Linux Xanmod Kernel with Lan Tian Modifications |
|  | `lantianLinuxXanmod.latest-generic-configfile` | linux-config | 6.12.3-xanmod1 |  |
|  | `lantianLinuxXanmod.latest-generic-lto` | [linux-xanmod-latest-generic-lto](https://www.kernel.org/) | 6.12.3-xanmod1 | Linux Xanmod Kernel with Lan Tian Modifications and Clang+ThinLTO |
|  | `lantianLinuxXanmod.latest-generic-lto-configfile` | linux-config | 6.12.3-xanmod1 |  |
...
<details>
<summary>Package set: python3Packages (15 packages)</summary>
...
|  | `python3Packages.runpod-python` | [runpod-python](https://github.com/runpod/runpod-python) | 1.7.6 | Python library for RunPod API and serverless worker SDK |
