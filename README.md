...
|  | `flapalerted` | [flapalerted](https://github.com/Kioubit/FlapAlerted) | 4.2.1 | BGP Update based flap detection |
...
|  | `funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2025-12-19 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
|  | `geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2025.12.19 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
| `x86_64-linux` | `i915-sriov` | [i915-sriov](https://github.com/strongtz/i915-sriov-dkms) | 0-unstable-2025-12-10 | DKMS module of Linux i915 driver with SR-IOV support |
...
|  | `peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | 9.2.2 | Automatically bans unwanted, leeching, and anomalous BT clients, with support for custom rules for qBittorrent and Transmission |
...
|  | `plasma-smart-video-wallpaper-reborn` | [plasma-smart-video-wallpaper-reborn](https://store.kde.org/p/2139746) | 2.8.0 | Plasma 6 wallpaper plugin to play videos on your Desktop/Lock Screen |
...
|  | `qemu-user-static` | [qemu-user-static](http://www.qemu.org/) | 10.1.3+ds-1 | Generic and open source machine emulator and virtualizer |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2025-12-18 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-12-21 | Unifies the management of LLM APIs across multiple backend services |
...
| `x86_64-linux` | `kernel-modules.i915-sriov` | [i915-sriov](https://github.com/strongtz/i915-sriov-dkms) | 0-unstable-2025-12-10 | DKMS module of Linux i915 driver with SR-IOV support |
...
|  | `lantianCustomized.llama-cpp` | [llama-cpp](https://github.com/ggml-org/llama.cpp) | 7490 | Inference of Meta's LLaMA model (and others) in pure C/C++ |
...
|  | `python3Packages.funasr` | [funasr](https://www.funasr.com/) | 0-unstable-2025-12-19 | Fundamental End-to-End Speech Recognition Toolkit and Open Source SOTA Pretrained Models |
...
|  | `uncategorized.flapalerted` | [flapalerted](https://github.com/Kioubit/FlapAlerted) | 4.2.1 | BGP Update based flap detection |
...
|  | `uncategorized.geolite2` | [geolite2](https://dev.maxmind.com/geoip/geoip2/geolite2/) | 2025.12.19 | MaxMind's GeoIP2 GeoLite2 Country, City, and ASN databases |
...
|  | `uncategorized.peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | 9.2.2 | Automatically bans unwanted, leeching, and anomalous BT clients, with support for custom rules for qBittorrent and Transmission |
...
|  | `uncategorized.plasma-smart-video-wallpaper-reborn` | [plasma-smart-video-wallpaper-reborn](https://store.kde.org/p/2139746) | 2.8.0 | Plasma 6 wallpaper plugin to play videos on your Desktop/Lock Screen |
...
|  | `uncategorized.qemu-user-static` | [qemu-user-static](http://www.qemu.org/) | 10.1.3+ds-1 | Generic and open source machine emulator and virtualizer |
...
|  | `uncategorized.rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | 0-unstable-2025-12-18 | Rime 配置：雾凇拼音 | 长期维护的简体词库 |
...
|  | `uncategorized.uni-api` | [uni-api](https://github.com/yym68686/uni-api) | 0-unstable-2025-12-21 | Unifies the management of LLM APIs across multiple backend services |
