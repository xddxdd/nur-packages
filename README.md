...
|  | `baidupcs-go` | [baidupcs-go](https://github.com/qjfoidnh/BaiduPCS-Go) | v3.9.5 | Baidu Netdisk commandline client, mimicking Linux shell file handling commands. |
...
|  | `boringssl-oqs` | [boringssl-oqs](https://openquantumsafe.org) | c4e62514e7f14ce5325226ccf9472617d810bcd0 | Fork of BoringSSL that includes prototype quantum-resistant key exchange and authentication in the TLS handshake based on liboqs |
...
|  | `decluttarr` | [decluttarr](https://github.com/ManiMatter/decluttarr) | v1.42.0 | Watches radarr, sonarr, lidarr and readarr download queues and removes downloads if they become stalled or no longer needed. |
...
|  | `fastapi-dls` | [fastapi-dls](https://gitea.publichub.eu/oscar.krause/fastapi-dls) | 006d3a18335190da554da997eaab021a7201181a | Minimal Delegated License Service (DLS) |
...
|  | `i915-sriov` | [i915-sriov](https://github.com/strongtz/i915-sriov-dkms) | 3d7a1b3fa4706d8da316d8e794d54db96856a2b9 | DKMS module of Linux i915 driver with SR-IOV support |
...
|  | `liboqs` | [liboqs](https://openquantumsafe.org) | a5ec23cf19763d36a558b8358345823ae45d57e5 | C library for prototyping and experimenting with quantum-resistant cryptography |
...
|  | `openssl-oqs-provider` | [openssl-oqs-provider](https://openquantumsafe.org) | ca582f93dab83232f3072a5dedcc175d017493f1 | OpenSSL 3 provider containing post-quantum algorithms |
...
|  | `peerbanhelper` | [peerbanhelper](https://github.com/Ghost-chu/PeerBanHelper) | v3.3.7 | 自动封禁不受欢迎、吸血和异常的 BT 客户端，并支持自定义规则。PeerId黑名单/UserAgent黑名单/IP CIDR/假进度检测/超量下载检测/主动探测 支持 qBittorrent/Transmission |
...
|  | `pterodactyl-wings` | [pterodactyl-wings](https://pterodactyl.io) | v1.11.13 | The server control plane for Pterodactyl Panel. |
...
|  | `rime-ice` | [rime-ice](https://dvel.me/posts/rime-ice/) | c29d07abe402ea3d79d3357dc458bdb78084f9b5 | Rime 配置：雾凇拼音 | 长期维护的简体词库  |
...
|  | `suwayomi-server` | [suwayomi-server](https://github.com/Suwayomi/Suwayomi-Server) | v1.0.0-r1498 | A rewrite of Tachiyomi for the Desktop |
...
| `Broken` | `vs-rife` | [vs-rife](https://github.com/HolyWu/vs-rife) | v5.0.0 | Real-Time Intermediate Flow Estimation for Video Frame Interpolation for VapourSynth |
