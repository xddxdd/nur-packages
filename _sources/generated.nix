...
}:
{
  ...
  fr24feed-arm64 = {
    ...
    version = "1.0.56-0";
    src = fetchurl {
      url = "https://repo-feed.flightradar24.com/pool/raspberrypi-stable/f/fr24feed/fr24feed_1.0.56-0_arm64.deb";
      hash = "sha256-9S67qyViGgvdjEZW9s8ooXvYciAnOZRk/eb2C0EuiCA=";
    };
  };
  fr24feed-armhf = {
  ...
  geolite2-country = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-CpqLZUiFMBpmyw3C+QuE/f2xxC4pr0wrJcZ7cVPruPk=";
    };
  };
  glauth = {
    pname = "glauth";
  ...
  rtpengine-stable = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "rtpengine";
      tag = "mr11.5.1.51";
      hash = "sha256-TmRzIKvNAloEqFyin8vevkdCXAhhk25xUNgPXhwhDsE=";
    };
  };
  runpod-python = {
    pname = "runpod-python";
