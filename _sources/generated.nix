...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  cachyos-kernel-patches = {
    ...
    version = "9e07f25545d3d303379c71f17f96e360eba5ecb9";
    src = fetchFromGitHub {
      owner = "CachyOS";
      repo = "kernel-patches";
      rev = "9e07f25545d3d303379c71f17f96e360eba5ecb9";
      fetchSubmodules = false;
      sha256 = "sha256-Rq77mMvHGCGDYyijRNCxG1/MFfobn/rOZaxn/GmhidM=";
    };
    date = "2024-05-04";
  };
  calibre-cops = {
  ...
  decluttarr = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.41.2";
      fetchSubmodules = false;
      sha256 = "sha256-ijvgxnx9N13wN1rSwjNMtqYLrZL6UcJg18H9xn5mIqU=";
    };
  };
  dingtalk = {
    pname = "dingtalk";
  ...
  liboqs = {
    pname = "liboqs";
    version = "b392919f6eb1ff4daa9eee7da2d2812fb2f0c987";
    src = fetchFromGitHub {
      owner = "open-quantum-safe";
      repo = "liboqs";
      rev = "b392919f6eb1ff4daa9eee7da2d2812fb2f0c987";
      fetchSubmodules = false;
      sha256 = "sha256-jyMhhXXfuiIw6T1Zkj4FbJKmJwL/n9QJGIXatTuIDFQ=";
    };
    date = "2024-05-04";
  };
  libqcef = {
  ...
  qq-amd64 = {
    pname = "qq-amd64";
    version = "Linux/QQ_3.2.7_240428_amd64_01";
    src = fetchurl {
      url = "https://dldir1.qq.com/qqfile/qq/QQNT/Linux/QQ_3.2.7_240428_amd64_01.deb";
      sha256 = "sha256-UzQ+URI4ODAE88E54bo8i07UARZZsvNYEhiKPAP/9EE=";
    };
  };
  qq-arm64 = {
    pname = "qq-arm64";
    version = "Linux/QQ_3.2.7_240428_arm64_01";
    src = fetchurl {
      url = "https://dldir1.qq.com/qqfile/qq/QQNT/Linux/QQ_3.2.7_240428_arm64_01.deb";
      sha256 = "sha256-G9c6/bag/nK8GLdpAeHlfRsBUDJHtnwsNkQTko1t16Y=";
    };
  };
  qqmusic = {
    pname = "qqmusic";
