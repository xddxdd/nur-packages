...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  liboqs = {
    pname = "liboqs";
    version = "d1e99b3f85d2eb7fe9ad3b9f58d36fd671da46a5";
    src = fetchFromGitHub {
      owner = "open-quantum-safe";
      repo = "liboqs";
      rev = "d1e99b3f85d2eb7fe9ad3b9f58d36fd671da46a5";
      fetchSubmodules = false;
      sha256 = "sha256-e914LDbw/2b0r4aFSZn8iFRSJq/nVoMfydNuJ+5z2pc=";
    };
    date = "2023-12-06";
  };
  libqcef = {
  ...
  linux-xanmod = {
    pname = "linux-xanmod";
    version = "6.6.5-xanmod1";
    src = fetchFromGitHub {
      owner = "xanmod";
      repo = "linux";
      rev = "6.6.5-xanmod1";
      fetchSubmodules = false;
      sha256 = "sha256-lmJ5Gix+CEqIu+cyBeqBq6xLZ94PjhU+6SbzAE0D8SY=";
    };
  };
  linux-xanmod-6_0 = {
  ...
  linux-xanmod-6_1 = {
    ...
    version = "6.1.66-xanmod1";
    src = fetchFromGitHub {
      owner = "xanmod";
      repo = "linux";
      rev = "6.1.66-xanmod1";
      fetchSubmodules = false;
      sha256 = "sha256-H3RTbBctvbKdsD1+G7zXVcTFb2NRON6nOzUgUW+zGxs=";
    };
  };
  nbfc-linux-lantian = {
