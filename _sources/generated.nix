...
}:
{
  ...
  bifrost = {
    ...
    version = "1.5.4";
    src = fetchurl {
      url = "https://github.com/maximhq/bifrost/archive/refs/tags/transports/v1.5.4.tar.gz";
      hash = "sha256-tCWXkIlRH0A8q2UfnRCAHuHz9Fbey/fUs5PXoxycTkM=";
    };
  };
  bilibili = {
    pname = "bilibili";
  ...
  calibre-cops = {
    ...
    version = "4.3.3";
    src = fetchurl {
      url = "https://github.com/mikespub-org/seblucas-cops/releases/download/4.3.3/cops-4.3.3-php84.zip";
  ...
  funasr = {
    pname = "funasr";
    version = "30c1c97d44eca98f00a72dab1894766ef850c26f";
    src = fetchFromGitHub {
      owner = "modelscope";
      repo = "FunASR";
      rev = "30c1c97d44eca98f00a72dab1894766ef850c26f";
      hash = "sha256-YjhNhJevEmq1U6bC/XFT8II/tvZuac0OCwuc0t/hvbQ=";
    };
    date = "2026-05-21";
  };
  geolite2-asn = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-EtRy1UugkbdNIBtMWCx7E8FIuvXDQj0L//AAk/FUD3k=";
    };
  };
  geolite2-city = {
    pname = "geolite2-city";
    ...
    src = fetchurl {
      ...
      hash = "sha256-BvCsoLkGLOzDpPbr4ZAoujIbG0lCU0yHD9SYdPopL+4=";
    };
  };
  geolite2-country = {
    ...
    src = fetchurl {
      ...
      hash = "sha256-cw0qVcJXolFfyx9BqBFuIBnLb4QI4+Sc1e3Ch4pSRPU=";
    };
  };
  glauth = {
    pname = "glauth";
  ...
  imewlconverter = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "imewlconverter";
      tag = "v3.4.1";
      hash = "sha256-8ERtMOlMJR7MjUnr+1djpFou0WWKzQTIPiNPTGew3YI=";
    };
  };
  inter-knot = {
    pname = "inter-knot";
  ...
  liboqs-unstable = {
    ...
    version = "813ba3467f8d15ed408edbdc03cf09ceb2699b41";
    src = fetchFromGitHub {
      owner = "open-quantum-safe";
      repo = "liboqs";
      rev = "813ba3467f8d15ed408edbdc03cf09ceb2699b41";
      hash = "sha256-HVakBDuVsWb5/RdjjqmvMKRvJDe9ya3GbcRQQAEYFsk=";
    };
    date = "2026-05-20";
  };
  libqcef = {
  ...
  llama-cpp = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "llama.cpp";
      tag = "b9279";
      hash = "sha256-TEsAvnplZBhDinitkNHt/bYHdIMJZzgF9Zw5JO3X2Z4=";
    };
  };
  loralib = {
    pname = "loralib";
  ...
  mtkclient = {
    pname = "mtkclient";
    version = "5794aba14a8753cd8186cd0ec2ce5ae73e3ea2f2";
    src = fetchFromGitHub {
      owner = "bkerler";
      repo = "mtkclient";
  ...
  nginx-auth-jwt = {
    ...
    src = fetchFromGitHub {
      ...
      tag = "0.13.1";
      fetchSubmodules = true;
      hash = "sha256-i8uPUXnfysj0gmXBQ9g1IRrYkW0+Gu8YPPBDdyDC2lY=";
    };
  };
  nginx-module-geoip2 = {
  ...
  rtpengine = {
    pname = "rtpengine";
    version = "fd0d1c270227b22ee85055bb1d523609e3bc05b3";
    src = fetchFromGitHub {
      owner = "sipwise";
      repo = "rtpengine";
      rev = "fd0d1c270227b22ee85055bb1d523609e3bc05b3";
      hash = "sha256-BLJR/5q7nyKEGVa2zqSOkf0JbiWrRPtVBOvvJfEa0vI=";
    };
    date = "2026-05-21";
  };
  rtpengine-stable = {
