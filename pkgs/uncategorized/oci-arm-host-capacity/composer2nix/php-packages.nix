...
let
  packages = {
    ...
    "hitrov/oci-api-php-request-sign" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "hitrov-oci-api-php-request-sign-62b61a77553f6fcca6019b609967bd7fbd5ca1bc";
        src = fetchurl {
          url = "https://api.github.com/repos/hitrov/oci-api-php-request-sign/zipball/62b61a77553f6fcca6019b609967bd7fbd5ca1bc";
          sha256 = "054l1hwahnrb5nwxyz9x3lzjm60s2yas5lvg7357p2zypnlkfjsj";
        };
      };
    };
    "phpoption/phpoption" = {
  ...
  devPackages = {
    ...
    "phpunit/phpunit" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "phpunit-phpunit-3e6f90ca7e3d02025b1d147bd8d4a89fd4ca8a1d";
        src = fetchurl {
          url = "https://api.github.com/repos/sebastianbergmann/phpunit/zipball/3e6f90ca7e3d02025b1d147bd8d4a89fd4ca8a1d";
          sha256 = "108bvzqbr35ypnly33zs8lwpk0xca0p9nbcrcr9z48jsclpkd143";
        };
      };
    };
